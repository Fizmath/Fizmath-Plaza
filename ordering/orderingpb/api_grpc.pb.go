...
const (
	...
	OrderingService_GetAll_FullMethodName      = "/orderingpb.OrderingService/GetAll"
	OrderingService_RemoveIds_FullMethodName   = "/orderingpb.OrderingService/RemoveIds"
)
...
func (c *orderingServiceClient) GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderingService_GetAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderingServiceClient) RemoveIds(ctx context.Context, in *RemoveIdsRequest, opts ...grpc.CallOption) (*RemoveIdsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveIdsResponse)
	err := c.cc.Invoke(ctx, OrderingService_RemoveIds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderingServiceServer) RemoveIds(context.Context, *RemoveIdsRequest) (*RemoveIdsResponse, error) {
...
func _OrderingService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderingService_GetAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrderingService_RemoveIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveIdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderingServiceServer).RemoveIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderingService_RemoveIds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderingServiceServer).RemoveIds(ctx, req.(*RemoveIdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OrderingService_RemoveIds_Handler,
		},
	},
